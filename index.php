...
<body>
    ...
    <!-- Swiper -->
    <div class="swiper mySwiper slibar-fix-top"><!-- อันนี้ -->
      <div class="swiper-wrapper">
        <div class="swiper-slide">
            <img src="https://cdn.pixabay.com/photo/2021/09/17/08/40/lake-6632026_1280.jpg" alt="picture">
            <a href="#" class="title-text" style="text-decoration:none;"><p>ภูเขาาาาาาาาาาาาา</p></a>
        ...
        <div class="swiper-slide">
            ...
            <a href="#" class="title-text" style="text-decoration:none;"><p>ภูเขาาาาาาาาาาาาา</p></a>
            <span class="sub-text"><p>งงงงงงงงงงงงงงงงงงงงงงงงงงงงงงงงงงงงงงงงงงงงงงงงงงงงงงงงงงงงงงงงงงงงงงงงงงงงงงงงง</p></span>
            <a href="#" class="btn btn-defaul btn-sm">Read more</a>
        </div>
        <div class="swiper-slide">
            <img src="https://cdn.pixabay.com/photo/2021/09/17/08/40/lake-6632026_1280.jpg" alt="picture">
            <a href="#" class="title-text" style="text-decoration:none;"><p>ภูเขาาาาาาาาาาาาา</p></a>
                ...
                <div class="forms">
                    ...
                    <div class="form-wrapper">
                        ...
                        <form class="form form-signup">
                            ...
                            <button type="submit" class="btn-signup"><a href="register.php">Continue</a></button>
                        </form>
                    </div>
                </div>
            </section>
