        ...
        <div class="container-fluid">
            ...
            <!-- Navbar : Menu -->
                <ul class="nav nav-tabs" role="tablist">
                    ...
                    <li class="nav-item"><a class="navbar nav-link" data-bs-toggle="tab" href="index.php" class="nav-link active">BLOG</a></li>
    ...
    <nav class="navbar navbar-expand-sm navbar-dark background-color:rgba(0,0,0,0) fix-top">
        ...
        <!-- Brand:logo -->
            ...
            <!-- Navbar : Menu -->
                <ul class="nav nav-tabs" role="tablist">
                    <li class="nav-item"><a class="navbar nav-link active" data-bs-toggle="tab" href="index.php" class="nav-link active">HOME</a></li>
                    <li class="nav-item"><a class="navbar nav-link" data-bs-toggle="tab" href="#" class="nav-link ">BLOG</a></li>
                    <li class="nav-item"><a class="navbar nav-link" data-bs-toggle="tab" href="#" class="nav-link ">TRAVEL</a></li>
                    <li class="nav-item"><a class="navbar nav-link" data-bs-toggle="tab" href="#" class="nav-link ">EAT</a></li>
                    <li class="nav-item"><a class="navbar nav-link" data-bs-toggle="tab" href="#" class="nav-link ">HOSTEL</a></li>
                </ul>
            ...
            <ul class="nav-item dropdown">
                <a  href="#" class="nav-link dropdown-toggle style-link" data-bs-toggle="dropdown"><i class="bi bi-people-fill"></i> <?php echo $_SESSION["name"]." ".$_SESSION["surname"]?> </a>
                    <div class="dropdown-menu" style="right:0">
                        <li><a href="connect.php" class="dropdown-item">PROFILE </a></li>
